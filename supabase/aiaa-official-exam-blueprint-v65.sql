-- AIAA Official Exam Blueprint V65

-- Replaces the temporary exam bank with the formal Level 1 to Level 5 certification exam system. This file fixes the V64 column order issue.
...
D. Storing user passwords in prompts', true, 1, 'Correct answer: A', '', true),
  (1, 31, 'Practical Task', 'L1 Basic Agent Workflow Build', 'Build and submit a Basic Agent Workflow.', 'Required evidence: user input handling, task analysis, one external API or tool, one tool call, execution logs, retry logic, clear error message, README, demo screenshot or demo video.', 20, 'Reviewer checks a runnable workflow, not a prompt-only or UI-only project.', true, '', '', true),
...
D. Because reviewers do not need evidence', true, 1, 'Correct answer: A', '', true),
  (2, 41, 'Practical Task', 'L2 Production Workflow System', 'Build and submit a Production Workflow System.', 'Required evidence: at least three tools, task status, queue or scheduler, retry, logging, state persistence, human override, Telegram or Discord notification, cost estimate, deployment guide.', 25, 'Reviewer checks production workflow quality.', true, '', '', true),
  (2, 42, 'Practical Task', 'L2 Failure Recovery Test', 'Demonstrate failure recovery.', 'Required evidence: simulated API failure, interrupted task, error log, retry behavior, human stop or restart control, final recovery record.', 25, 'Reviewer checks recovery under controlled failure.', true, '', '', true),
...
D. No deployment risk', true, 1, 'Correct answer: A', '', true),
  (3, 51, 'Practical Task', 'L3 Production Multi Agent System', 'Build and submit a Production Multi Agent System.', 'Required evidence: at least three agents, clear roles, supervisor or planner, shared memory, state recovery, tool routing, and API documentation.', 30, 'Reviewer checks multi agent system architecture.', true, '', '', true),
  (3, 52, 'Practical Task', 'L3 Monitoring and Cost Tracking', 'Submit monitoring and cost tracking evidence.', 'Required evidence: monitoring dashboard, cost tracking, error rate, latency tracking, success rate records, and execution trace query.', 20, 'Reviewer checks operational visibility.', true, '', '', true),
  (3, 53, 'Practical Task', 'L3 Security and Recovery Layer', 'Submit security and recovery evidence.', 'Required evidence: permission control, secrets management, audit logs, data isolation, failure recovery, and benchmark report.', 20, 'Reviewer checks security and resilience.', true, '', '', true),
  (3, 54, 'Architecture Review', 'L3 Architecture Review', 'Submit the full architecture review package.', 'Required documents: system architecture diagram, agent role diagram, data flow diagram, memory design, security design, cost design, deployment architecture, benchmark results, and API documentation.', 30, 'Council or senior reviewer reviews architecture package.', true, '', '', true),
  (4, 1, 'Company Questionnaire', 'L4 Company Basics', 'Company legal name, website, and operating identity', 'Provide a precise answer with supporting evidence.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 2, 'Company Questionnaire', 'L4 Company Basics', 'Team structure and accountable owner', 'Provide a precise answer with supporting evidence.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 3, 'Company Questionnaire', 'L4 Company Basics', 'Product positioning and target customer', 'Provide a precise answer with supporting evidence.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 4, 'Company Questionnaire', 'L4 Product Capability', 'Real AI Agent product description', 'Explain the current production state and evidence.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 5, 'Company Questionnaire', 'L4 Product Capability', 'Agent functions and customer workflow', 'Explain the current production state and evidence.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 6, 'Company Questionnaire', 'L4 Product Capability', 'Product stability and production usage', 'Explain the current production state and evidence.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 7, 'Company Questionnaire', 'L4 Product Capability', 'Active users or customer usage evidence', 'Explain the current production state and evidence.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 8, 'Company Questionnaire', 'L4 Production Infrastructure', 'Production infrastructure overview', 'Provide operational details and evidence.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 9, 'Company Questionnaire', 'L4 Production Infrastructure', 'SLA and uptime target', 'Provide operational details and evidence.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 10, 'Company Questionnaire', 'L4 Production Infrastructure', 'Incident response process', 'Provide operational details and evidence.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 11, 'Company Questionnaire', 'L4 Production Infrastructure', 'Monitoring and scaling model', 'Provide operational details and evidence.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 12, 'Company Questionnaire', 'L4 Security Review', 'Data protection and retention policy', 'Provide documents or reviewer access evidence.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 13, 'Company Questionnaire', 'L4 Security Review', 'API governance and access control', 'Provide documents or reviewer access evidence.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 14, 'Company Questionnaire', 'L4 Security Review', 'Security documentation and risk handling', 'Provide documents or reviewer access evidence.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 15, 'Company Questionnaire', 'L4 Customer Support', 'Customer support workflow', 'Explain support operations and proof.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 16, 'Company Questionnaire', 'L4 Customer Support', 'Customer issue tracking and escalation', 'Explain support operations and proof.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 17, 'Company Questionnaire', 'L4 Revenue Systems', 'Revenue model and payment flow', 'Submit proof or redacted documentation.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 18, 'Company Questionnaire', 'L4 Revenue Systems', 'Contracts, subscriptions, or revenue tier evidence', 'Submit proof or redacted documentation.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 19, 'Company Questionnaire', 'L4 Benchmark', 'Benchmark system and performance metrics', 'Provide reports, screenshots, or dashboard links.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 20, 'Company Questionnaire', 'L4 Benchmark', 'Uptime report and production reliability evidence', 'Provide reports, screenshots, or dashboard links.', 5, 'Reviewer scores company evidence.', true, '', '', true),
  (4, 21, 'Document Review', 'L4 Required Document', 'Official website', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', 10, 'Required document for company certification.', true, '', '', true),
  (4, 22, 'Document Review', 'L4 Required Document', 'Product demo', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', 10, 'Required document for company certification.', true, '', '', true),
  (4, 23, 'Document Review', 'L4 Required Document', 'Company documents', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', 10, 'Required document for company certification.', true, '', '', true),
  (4, 24, 'Document Review', 'L4 Required Document', 'API documentation', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', 10, 'Required document for company certification.', true, '', '', true),
  (4, 25, 'Document Review', 'L4 Required Document', 'Customer case studies', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', 10, 'Required document for company certification.', true, '', '', true),
  (4, 26, 'Document Review', 'L4 Required Document', 'Revenue proof', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', 10, 'Required document for company certification.', true, '', '', true),
  (4, 27, 'Document Review', 'L4 Required Document', 'Benchmark report', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', 10, 'Required document for company certification.', true, '', '', true),
  (4, 28, 'Document Review', 'L4 Required Document', 'Security or uptime report', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', 10, 'Required document for company certification.', true, '', '', true),
  (4, 29, 'Demo Review', 'L4 Demo Review', 'Complete one company product demo review.', 'Reviewers check if the product runs in production, customer workflow is complete, monitoring exists, failure handling works, support workflow exists, and business delivery is credible.', 20, 'Manual company demo review.', true, '', '', true),
  (5, 1, 'Impact Review', 'L5 Fellow Review', 'Global impact', 'Provide evidence of international influence, adoption, references, or ecosystem reach.', 10, 'Council and Fellow Review item.', true, '', '', true),
  (5, 2, 'Impact Review', 'L5 Fellow Review', 'Open source impact', 'Provide repository, maintainer, adoption, contributor, or downstream usage evidence.', 10, 'Council and Fellow Review item.', true, '', '', true),
  (5, 3, 'Impact Review', 'L5 Fellow Review', 'Technical originality', 'Explain the original technical contribution, framework, protocol, research, or infrastructure.', 10, 'Council and Fellow Review item.', true, '', '', true),
  (5, 4, 'Impact Review', 'L5 Fellow Review', 'Public trust', 'Provide evidence of transparent work, reputation, ethics, and public accountability.', 10, 'Council and Fellow Review item.', true, '', '', true),
  (5, 5, 'Impact Review', 'L5 Fellow Review', 'Ecosystem contribution', 'List concrete contributions to the AI Agent ecosystem.', 10, 'Council and Fellow Review item.', true, '', '', true),
  (5, 6, 'Impact Review', 'L5 Fellow Review', 'Standards design ability', 'Explain standards, protocols, governance, review methods, or evaluation systems the applicant can help define.', 10, 'Council and Fellow Review item.', true, '', '', true),
  (5, 7, 'Impact Review', 'L5 Fellow Review', 'AI governance understanding', 'Explain governance thinking, safety tradeoffs, accountability, and public infrastructure thinking.', 10, 'Council and Fellow Review item.', true, '', '', true),
  (5, 8, 'Impact Review', 'L5 Fellow Review', 'Industry leadership', 'Provide evidence of leadership across companies, communities, conferences, or publications.', 10, 'Council and Fellow Review item.', true, '', '', true),
  (5, 9, 'Impact Review', 'L5 Fellow Review', 'Cross organization coordination', 'Provide evidence of working across teams, communities, open source groups, or companies.', 10, 'Council and Fellow Review item.', true, '', '', true),
  (5, 10, 'Impact Review', 'L5 Fellow Review', 'Long term contribution record', 'Provide a timeline of durable contributions and third party validation.', 10, 'Council and Fellow Review item.', true, '', '', true)

-- AIAA Official Exam Blueprint V66

-- Replaces the temporary exam bank with the formal Level 1 to Level 5 certification exam system. This file fixes the V64 and V65 non multiple choice row order issue.
...
insert into public.aiaa_exam_questions(level, position, exam_section, question_type, category, question, prompt, required, points, reviewer_notes, expected_answer_format, is_active) values
...
B. System prompt
C. Temperature
D. README', true, 1, 'Correct answer: B', '', true),
...
D. Tool calls stop working forever', true, 1, 'Correct answer: B', '', true),
...
C. To choose a logo
D. To hide logs', true, 1, 'Correct answer: B', '', true),
...
D. It cannot call tools', true, 1, 'Correct answer: B', '', true),
...
D. It only affects website colors', true, 1, 'Correct answer: B', '', true),
...
C. More API keys
D. More memory storage', true, 1, 'Correct answer: B', '', true),
...
D. To hide tool schemas', true, 1, 'Correct answer: A', '', true),
...
D. Safety constraints', true, 1, 'Correct answer: B', '', true),
...
D. A prompt screenshot only', true, 1, 'Correct answer: B', '', true),
...
D. Saving passwords in logs', true, 1, 'Correct answer: A', '', true),
...
D. Which browser tab is active', true, 1, 'Correct answer: A', '', true),
...
D. The README has a title', true, 1, 'Correct answer: B', '', true),
...
D. To skip authentication', true, 1, 'Correct answer: A', '', true),
...
D. A color palette', true, 1, 'Correct answer: B', '', true),
...
D. Only when the UI is dark mode', true, 1, 'Correct answer: B', '', true),
...
D. It requires manual copy paste for every step', true, 1, 'Correct answer: A', '', true),
...
D. A certificate ID', true, 1, 'Correct answer: A', '', true),
...
D. It prevents all bugs', true, 1, 'Correct answer: A', '', true),
...
C. Deletes all logs
D. Replaces deployment', true, 1, 'Correct answer: A', '', true),
...
D. In the page title', true, 1, 'Correct answer: B', '', true),
...
D. So users cannot run it', true, 1, 'Correct answer: A', '', true),
...
C. Only a screenshot
D. Only a sales page', true, 1, 'Correct answer: A', '', true),
...
D. Hide the failure from logs', true, 1, 'Correct answer: A', '', true),
...
B. Random emojis
C. Hidden API keys
D. Browser zoom level', true, 1, 'Correct answer: A', '', true),
...
C. Logging failures
D. Recovering temporary errors', true, 1, 'Correct answer: A', '', true),
...
D. Ignoring logs', true, 1, 'Correct answer: A', '', true),
...
B. A blank screen
C. No output
D. A slogan', true, 1, 'Correct answer: A', '', true),
...
D. Certifying users automatically', true, 1, 'Correct answer: A', '', true),
...
D. Issuing certificates', true, 1, 'Correct answer: A', '', true),
...
D. Storing user passwords in prompts', true, 1, 'Correct answer: A', '', true),
  (1, 31, 'Practical Task', 'Practical Task', 'L1 Basic Agent Workflow Build', 'Build and submit a Basic Agent Workflow.', 'Required evidence: user input handling, task analysis, one external API or tool, one tool call, execution logs, retry logic, clear error message, README, demo screenshot or demo video.', true, 20, 'Reviewer checks a runnable workflow, not a prompt-only or UI-only project.', '', true),
...
D. Too many badges', true, 1, 'Correct answer: A', '', true),
...
C. Only the logo
D. Only the certificate color', true, 1, 'Correct answer: A', '', true),
...
D. To remove monitoring', true, 1, 'Correct answer: A', '', true),
...
D. Removing errors', true, 1, 'Correct answer: A', '', true),
...
D. Nowhere in production', true, 1, 'Correct answer: A', '', true),
...
D. Marketing headlines', true, 1, 'Correct answer: A', '', true),
...
D. Replacing all logs', true, 1, 'Correct answer: A', '', true),
...
D. To reduce documentation', true, 1, 'Correct answer: A', '', true),
...
B. It changes fonts
C. It disables logs
D. It replaces API keys', true, 1, 'Correct answer: A', '', true),
...
D. none', true, 1, 'Correct answer: A', '', true),
...
B. A public password
C. A browser icon
D. A README title', true, 1, 'Correct answer: A', '', true),
...
C. A hidden bug
D. A payment link only', true, 1, 'Correct answer: A', '', true),
...
D. No timestamps', true, 1, 'Correct answer: A', '', true),
...
B. Task ID
C. Error code
D. Timestamp', true, 1, 'Correct answer: A', '', true),
...
D. Never', true, 1, 'Correct answer: A', '', true),
...
D. Only a prompt', true, 1, 'Correct answer: A', '', true),
...
D. Removing tool schemas', true, 1, 'Correct answer: A', '', true),
...
D. The certificate ID', true, 1, 'Correct answer: A', '', true),
...
D. Uploading logos', true, 1, 'Correct answer: A', '', true),
...
B. Randomly
C. By logo color
D. By file name length', true, 1, 'Correct answer: A', '', true),
...
D. Removing estimates', true, 1, 'Correct answer: A', '', true),
...
D. Remove monitoring', true, 1, 'Correct answer: A', '', true),
...
B. To skip review
C. To hide defects
D. To remove tests', true, 1, 'Correct answer: A', '', true),
...
D. Removing state', true, 1, 'Correct answer: A', '', true),
...
D. To replace README', true, 1, 'Correct answer: A', '', true),
...
C. Rendering badges
D. Editing videos', true, 1, 'Correct answer: A', '', true),
...
C. All bad prompts
D. Missing README', true, 1, 'Correct answer: A', '', true),
...
D. User ranking only', true, 1, 'Correct answer: A', '', true),
...
B. Only logo size
C. Only social links
D. Only homepage text', true, 1, 'Correct answer: A', '', true),
...
D. README examples with real keys', true, 1, 'Correct answer: A', '', true),
...
C. To skip tests
D. To delete users', true, 1, 'Correct answer: A', '', true),
...
D. Marketing copy', true, 1, 'Correct answer: A', '', true),
...
D. Hiding errors', true, 1, 'Correct answer: A', '', true),
...
D. Storing secrets publicly', true, 1, 'Correct answer: A', '', true),
...
D. Removing tests', true, 1, 'Correct answer: A', '', true),
...
C. No logs
D. No external integrations', true, 1, 'Correct answer: A', '', true),
...
D. It makes logs unnecessary', true, 1, 'Correct answer: A', '', true),
...
D. Because reviewers do not need evidence', true, 1, 'Correct answer: A', '', true),
  (2, 41, 'Practical Task', 'Practical Task', 'L2 Production Workflow System', 'Build and submit a Production Workflow System.', 'Required evidence: at least three tools, task status, queue or scheduler, retry, logging, state persistence, human override, Telegram or Discord notification, cost estimate, deployment guide.', true, 25, 'Reviewer checks production workflow quality.', '', true),
  (2, 42, 'Practical Task', 'Practical Task', 'L2 Failure Recovery Test', 'Demonstrate failure recovery.', 'Required evidence: simulated API failure, interrupted task, error log, retry behavior, human stop or restart control, final recovery record.', true, 25, 'Reviewer checks recovery under controlled failure.', '', true),
...
D. Removing logs', true, 1, 'Correct answer: A', '', true),
...
C. To hide failures
D. To skip testing', true, 1, 'Correct answer: A', '', true),
...
D. Removes human review', true, 1, 'Correct answer: A', '', true),
...
D. A static certificate', true, 1, 'Correct answer: A', '', true),
...
C. All secrets
D. No logs', true, 1, 'Correct answer: A', '', true),
...
C. Hiding routes
D. Removing queues', true, 1, 'Correct answer: A', '', true),
...
D. Which file icon appears', true, 1, 'Correct answer: A', '', true),
...
D. Delete all traces', true, 1, 'Correct answer: A', '', true),
...
D. To hide cost', true, 1, 'Correct answer: A', '', true),
...
D. Supervisor validation', true, 1, 'Correct answer: A', '', true),
...
D. Replacing access control', true, 1, 'Correct answer: A', '', true),
...
D. Secret keys', true, 1, 'Correct answer: A', '', true),
...
C. Replacing all logs
D. Storing public passwords', true, 1, 'Correct answer: A', '', true),
...
D. To avoid testing', true, 1, 'Correct answer: A', '', true),
...
D. Less audit need', true, 1, 'Correct answer: A', '', true),
...
C. No audit
D. No data isolation', true, 1, 'Correct answer: A', '', true),
...
B. button size
C. domain age only
D. UI color', true, 1, 'Correct answer: A', '', true),
...
D. Workflow has checkpoints', true, 1, 'Correct answer: A', '', true),
...
D. To avoid interfaces', true, 1, 'Correct answer: A', '', true),
...
C. No retries
D. Manual copy paste', true, 1, 'Correct answer: A', '', true),
...
D. The homepage headline', true, 1, 'Correct answer: A', '', true),
...
D. hidden failures', true, 1, 'Correct answer: A', '', true),
...
D. Manual only releases', true, 1, 'Correct answer: A', '', true),
...
C. A PPT
D. A prompt', true, 1, 'Correct answer: A', '', true),
...
B. To hide errors
C. To avoid logs
D. To prevent testing', true, 1, 'Correct answer: A', '', true),
...
C. no roles
D. no records', true, 1, 'Correct answer: A', '', true),
...
B. only brand story
C. no error codes
D. no request examples', true, 1, 'Correct answer: A', '', true),
...
C. A prompt type
D. A private password', true, 1, 'Correct answer: A', '', true),
...
B. Font size
C. Badge color
D. Ranking title', true, 1, 'Correct answer: A', '', true),
...
D. To skip tests', true, 1, 'Correct answer: A', '', true),
...
C. Log all secrets
D. Put keys in prompts', true, 1, 'Correct answer: A', '', true),
...
B. raw passwords
C. private tokens
D. nothing', true, 1, 'Correct answer: A', '', true),
...
D. To skip encryption decisions', true, 1, 'Correct answer: A', '', true),
...
C. Disable logs
D. Share all secrets', true, 1, 'Correct answer: A', '', true),
...
D. It cannot happen in agents', true, 1, 'Correct answer: A', '', true),
...
B. only screenshots
C. only slogans
D. no diagrams', true, 1, 'Correct answer: A', '', true),
...
D. no metrics', true, 1, 'Correct answer: A', '', true),
...
D. A prompt token type', true, 1, 'Correct answer: A', '', true),
...
B. only sales copy
C. no token estimate
D. no usage data', true, 1, 'Correct answer: A', '', true),
...
B. number of colors
C. number of slogans
D. length of title', true, 1, 'Correct answer: A', '', true),
...
B. only a screenshot
C. only a badge
D. no reproducibility detail', true, 1, 'Correct answer: A', '', true),
...
D. To hide failures', true, 1, 'Correct answer: A', '', true),
...
C. no evidence
D. no data', true, 1, 'Correct answer: A', '', true),
...
D. It ignores cost', true, 1, 'Correct answer: A', '', true),
...
C. Rendering logos
D. Removing APIs', true, 1, 'Correct answer: A', '', true),
...
D. To avoid deployment', true, 1, 'Correct answer: A', '', true),
...
C. No tool calls
D. No run history', true, 1, 'Correct answer: A', '', true),
...
B. logo only
C. no docs
D. no benchmark', true, 1, 'Correct answer: A', '', true),
...
D. all reviews skipped', true, 1, 'Correct answer: A', '', true),
...
D. No deployment risk', true, 1, 'Correct answer: A', '', true),
  (3, 51, 'Practical Task', 'Practical Task', 'L3 Production Multi Agent System', 'Build and submit a Production Multi Agent System.', 'Required evidence: at least three agents, clear roles, supervisor or planner, shared memory, state recovery, tool routing, and API documentation.', true, 30, 'Reviewer checks multi agent system architecture.', '', true),
  (3, 52, 'Practical Task', 'Practical Task', 'L3 Monitoring and Cost Tracking', 'Submit monitoring and cost tracking evidence.', 'Required evidence: monitoring dashboard, cost tracking, error rate, latency tracking, success rate records, and execution trace query.', true, 20, 'Reviewer checks operational visibility.', '', true),
  (3, 53, 'Practical Task', 'Practical Task', 'L3 Security and Recovery Layer', 'Submit security and recovery evidence.', 'Required evidence: permission control, secrets management, audit logs, data isolation, failure recovery, and benchmark report.', true, 20, 'Reviewer checks security and resilience.', '', true),
  (3, 54, 'Architecture Review', 'Architecture Review', 'L3 Architecture Review', 'Submit the full architecture review package.', 'Required documents: system architecture diagram, agent role diagram, data flow diagram, memory design, security design, cost design, deployment architecture, benchmark results, and API documentation.', true, 30, 'Council or senior reviewer reviews architecture package.', '', true),
  (4, 1, 'Company Questionnaire', 'Questionnaire', 'L4 Company Basics', 'Company legal name, website, and operating identity', 'Provide a precise answer with supporting evidence.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 2, 'Company Questionnaire', 'Questionnaire', 'L4 Company Basics', 'Team structure and accountable owner', 'Provide a precise answer with supporting evidence.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 3, 'Company Questionnaire', 'Questionnaire', 'L4 Company Basics', 'Product positioning and target customer', 'Provide a precise answer with supporting evidence.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 4, 'Company Questionnaire', 'Questionnaire', 'L4 Product Capability', 'Real AI Agent product description', 'Explain the current production state and evidence.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 5, 'Company Questionnaire', 'Questionnaire', 'L4 Product Capability', 'Agent functions and customer workflow', 'Explain the current production state and evidence.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 6, 'Company Questionnaire', 'Questionnaire', 'L4 Product Capability', 'Product stability and production usage', 'Explain the current production state and evidence.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 7, 'Company Questionnaire', 'Questionnaire', 'L4 Product Capability', 'Active users or customer usage evidence', 'Explain the current production state and evidence.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 8, 'Company Questionnaire', 'Questionnaire', 'L4 Production Infrastructure', 'Production infrastructure overview', 'Provide operational details and evidence.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 9, 'Company Questionnaire', 'Questionnaire', 'L4 Production Infrastructure', 'SLA and uptime target', 'Provide operational details and evidence.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 10, 'Company Questionnaire', 'Questionnaire', 'L4 Production Infrastructure', 'Incident response process', 'Provide operational details and evidence.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 11, 'Company Questionnaire', 'Questionnaire', 'L4 Production Infrastructure', 'Monitoring and scaling model', 'Provide operational details and evidence.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 12, 'Company Questionnaire', 'Questionnaire', 'L4 Security Review', 'Data protection and retention policy', 'Provide documents or reviewer access evidence.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 13, 'Company Questionnaire', 'Questionnaire', 'L4 Security Review', 'API governance and access control', 'Provide documents or reviewer access evidence.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 14, 'Company Questionnaire', 'Questionnaire', 'L4 Security Review', 'Security documentation and risk handling', 'Provide documents or reviewer access evidence.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 15, 'Company Questionnaire', 'Questionnaire', 'L4 Customer Support', 'Customer support workflow', 'Explain support operations and proof.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 16, 'Company Questionnaire', 'Questionnaire', 'L4 Customer Support', 'Customer issue tracking and escalation', 'Explain support operations and proof.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 17, 'Company Questionnaire', 'Questionnaire', 'L4 Revenue Systems', 'Revenue model and payment flow', 'Submit proof or redacted documentation.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 18, 'Company Questionnaire', 'Questionnaire', 'L4 Revenue Systems', 'Contracts, subscriptions, or revenue tier evidence', 'Submit proof or redacted documentation.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 19, 'Company Questionnaire', 'Questionnaire', 'L4 Benchmark', 'Benchmark system and performance metrics', 'Provide reports, screenshots, or dashboard links.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 20, 'Company Questionnaire', 'Questionnaire', 'L4 Benchmark', 'Uptime report and production reliability evidence', 'Provide reports, screenshots, or dashboard links.', true, 5, 'Reviewer scores company evidence.', '', true),
  (4, 21, 'Document Review', 'Document Review', 'L4 Required Document', 'Official website', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', true, 10, 'Required document for company certification.', '', true),
  (4, 22, 'Document Review', 'Document Review', 'L4 Required Document', 'Product demo', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', true, 10, 'Required document for company certification.', '', true),
  (4, 23, 'Document Review', 'Document Review', 'L4 Required Document', 'Company documents', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', true, 10, 'Required document for company certification.', '', true),
  (4, 24, 'Document Review', 'Document Review', 'L4 Required Document', 'API documentation', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', true, 10, 'Required document for company certification.', '', true),
  (4, 25, 'Document Review', 'Document Review', 'L4 Required Document', 'Customer case studies', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', true, 10, 'Required document for company certification.', '', true),
  (4, 26, 'Document Review', 'Document Review', 'L4 Required Document', 'Revenue proof', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', true, 10, 'Required document for company certification.', '', true),
  (4, 27, 'Document Review', 'Document Review', 'L4 Required Document', 'Benchmark report', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', true, 10, 'Required document for company certification.', '', true),
  (4, 28, 'Document Review', 'Document Review', 'L4 Required Document', 'Security or uptime report', 'Upload or link the required document. Redact sensitive customer or financial information where needed.', true, 10, 'Required document for company certification.', '', true),
  (4, 29, 'Demo Review', 'Demo Review', 'L4 Demo Review', 'Complete one company product demo review.', 'Reviewers check if the product runs in production, customer workflow is complete, monitoring exists, failure handling works, support workflow exists, and business delivery is credible.', true, 20, 'Manual company demo review.', '', true),
  (5, 1, 'Impact Review', 'Fellow Review', 'L5 Fellow Review', 'Global impact', 'Provide evidence of international influence, adoption, references, or ecosystem reach.', true, 10, 'Council and Fellow Review item.', '', true),
  (5, 2, 'Impact Review', 'Fellow Review', 'L5 Fellow Review', 'Open source impact', 'Provide repository, maintainer, adoption, contributor, or downstream usage evidence.', true, 10, 'Council and Fellow Review item.', '', true),
  (5, 3, 'Impact Review', 'Fellow Review', 'L5 Fellow Review', 'Technical originality', 'Explain the original technical contribution, framework, protocol, research, or infrastructure.', true, 10, 'Council and Fellow Review item.', '', true),
  (5, 4, 'Impact Review', 'Fellow Review', 'L5 Fellow Review', 'Public trust', 'Provide evidence of transparent work, reputation, ethics, and public accountability.', true, 10, 'Council and Fellow Review item.', '', true),
  (5, 5, 'Impact Review', 'Fellow Review', 'L5 Fellow Review', 'Ecosystem contribution', 'List concrete contributions to the AI Agent ecosystem.', true, 10, 'Council and Fellow Review item.', '', true),
  (5, 6, 'Impact Review', 'Fellow Review', 'L5 Fellow Review', 'Standards design ability', 'Explain standards, protocols, governance, review methods, or evaluation systems the applicant can help define.', true, 10, 'Council and Fellow Review item.', '', true),
  (5, 7, 'Impact Review', 'Fellow Review', 'L5 Fellow Review', 'AI governance understanding', 'Explain governance thinking, safety tradeoffs, accountability, and public infrastructure thinking.', true, 10, 'Council and Fellow Review item.', '', true),
  (5, 8, 'Impact Review', 'Fellow Review', 'L5 Fellow Review', 'Industry leadership', 'Provide evidence of leadership across companies, communities, conferences, or publications.', true, 10, 'Council and Fellow Review item.', '', true),
  (5, 9, 'Impact Review', 'Fellow Review', 'L5 Fellow Review', 'Cross organization coordination', 'Provide evidence of working across teams, communities, open source groups, or companies.', true, 10, 'Council and Fellow Review item.', '', true),
  (5, 10, 'Impact Review', 'Fellow Review', 'L5 Fellow Review', 'Long term contribution record', 'Provide a timeline of durable contributions and third party validation.', true, 10, 'Council and Fellow Review item.', '', true)
on conflict (level, position) do update set
  ...
  expected_answer_format = excluded.expected_answer_format,
  is_active = true,
  updated_at = now();

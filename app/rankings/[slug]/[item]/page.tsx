...
const previewRows: PreviewRow[] = [
  {
    ...
    summary: "A pending AIAA product profile for a verified AI Agent product. This page will store product evidence, capability notes, review status, and certification history.",
    capabilities: ["Product evidence review", "Capability summary", "Certification status", "Public registry linkage"],
    bestFor: "Buyers and operators checking whether a commercial AI Agent product has passed AIAA review.",
    evidence: "AIAA registry submission, product website, customer proof, benchmark evidence, and certification review."
  },
  {
    rank: "02",
    ...
    summary: "A pending profile for a platform that helps teams build, run, and manage production AI Agent systems.",
    capabilities: ["Workflow deployment", "Agent orchestration", "Team operation", "Production monitoring"],
    bestFor: "Companies comparing production ready AI Agent platforms.",
    evidence: "Product documentation, platform demo, customer proof, production usage, and review checklist."
  },
  {
    rank: "03",
    ...
    summary: "A pending profile for an autonomous workflow system that coordinates tasks, tools, memory, and execution logic.",
    capabilities: ["Task routing", "Tool calling", "Workflow execution", "Failure handling"],
    bestFor: "Operators looking for agent systems that complete repeatable business workflows.",
    evidence: "Workflow evidence, logs, benchmark output, human handoff design, and reliability review."
  },
  {
    rank: "04",
    ...
    summary: "A pending profile for an enterprise AI Agent stack covering governance, integrations, access control, and deployment.",
    capabilities: ["Enterprise integration", "Access control", "Audit trail", "Safety policy"],
    bestFor: "Enterprise teams comparing AI Agent infrastructure vendors.",
    evidence: "Company review, security documents, deployment proof, user controls, and compliance notes."
  },
  {
    rank: "05",
    ...
    summary: "A pending profile for infrastructure products that support AI Agent execution, memory, evaluation, observability, or tool access.",
    capabilities: ["Agent infrastructure", "Monitoring", "Evaluation", "Tool integration"],
    bestFor: "Teams building agent systems and choosing infrastructure components.",
    evidence: "Registry submission, technical documentation, integration proof, and AIAA review notes."
  }
]

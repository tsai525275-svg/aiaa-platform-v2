const navItems = ["World", "Standards", "Rankings", "Registry", "Access"];
      ...
      <div className="mx-auto mt-4 flex w-[min(1440px,calc(100vw-24px))] items-center justify-between gap-8 rounded-full border border-white/6 bg-[linear-gradient(180deg,rgba(15,16,20,0.72),rgba(9,10,14,0.54))] px-6 py-3 shadow-[0_18px_60px_rgba(0,0,0,0.24)] backdrop-blur-[28px] md:w-[min(1440px,calc(100vw-40px))] md:px-8">
        <div className="flex items-center gap-5 md:gap-6">
          ...
          <div className="min-w-0">
            <div className="text-[1.85rem] font-semibold tracking-[0.08em] text-white md:text-[2rem]">
              AIAA
            </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href="#access"
            className="inline-flex min-h-11 items-center justify-center rounded-full border border-white/15 bg-white px-5 text-sm font-medium text-black"
          >
            Enter AIAA
          </a>
        </div>
